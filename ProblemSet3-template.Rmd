...
Then, we will predict the electoral vote outcome of the election, using a post-stratification outcome divided into states and compare it with the popular vote prediction.
