...
In our models, we do not need to worry about the violation of the first assumption since all of our predictor variables are categorical; hence, categorization of the independent variables is not neccessary.  
Similarly, since our reponse variables, vote_trump and vote_biden are binary, and the size of the survey data is large enough, we can confirm that the second and the thrid assumptions are also satisfied.  
...
(Figure n) For Biden, as opposed to Trump, shows a high estimate in the black race (0.999153), but has a low estimate in a native race(-0.441602). Also, younger people are more likely to vote, individual with high income ($150,000 or more) lowers the log odds(-0.046616), but overall well distributed.
