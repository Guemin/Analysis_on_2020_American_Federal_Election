...
ggplot(data.frame(trump_biden), aes(x=trump_biden)) +
  geom_bar() + ggtitle("Predicted Win Counts Per State") + xlab("Biden | Trump") + ylab("Count")
```
...
2. Conclusion: To conclude, based off the estimated proportion of voters in favor of voting for Donald Trump being 0.4334 (43.34%) and expected to win 31 states, we predict that Trump will win the 2020 president election.  (......)
