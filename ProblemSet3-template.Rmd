...
To breifly explain, we will include demographic variables such as age group, gender, race, and eucation attainment in the models; here, we will organize ages by categorizing them into different age groups.
