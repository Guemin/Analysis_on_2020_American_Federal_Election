...
model <- glmer(as.factor(vote_trump) ~ gender + (1|age_group),
...
model <- glmer(vote_trump ~ age_group + gender + race_ethnicity + education + (1|household_income), 
            data=survey_data, family = binomial)
model2 <- glm(vote_trump ~ age_group + gender + race_ethnicity + education + household_income, 
>>>>>>> 4b53e77b3702dc9a2bef06bf7efef78b7c9de2b9
            data=survey_data)
