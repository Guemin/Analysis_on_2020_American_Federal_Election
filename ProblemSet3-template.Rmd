...
biden_win
```
Under the assumption that whoever gets a higher expected proportion for each state wins in that state, Trump is expected to win in 30 states, and Biden is expected to win in 16 states. 
