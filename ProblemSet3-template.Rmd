...
ggplot(data.frame(trump_biden), aes(x=trump_biden)) +
  geom_bar(width = 0.3) + ggtitle("Figure n: Predicted Win Counts Per State") + xlab("Biden | Trump") + ylab("Count") + theme(plot.margin = margin(1.5,1,1.5,1, "cm"))
...
The histogram above shows the predicted win counts per state. Trump is expected to have a higher proportion of being elected in 31 states, and Biden has a higher proportion of voters voting for him in 20 states, which makes Trump the winner of the presidential election. Both popular vote and electoral vote shows same prediction where Trump wins the election.   

**Swing State** 
Swing States are the key battleground states that will determine the outcome of the election: North Carolina, Florida, Pennsylvania, Michigan, Arizona, Wisconsin, and Ohio. Figure N shows a brief result of the proportion for each swing state. Looking at the difference of proportion between Trump and Biden for each state, Trump is expected to get the inside track in most of the states, except for Michigan(0.4562030) and Wisconsin(0.4124047), where Biden is expected to have a higher proportion to get voted with 0.4562(45.62%) and 0.4124(41.24%).  
Figure N also expects Trump to win by a landslide, since he wins 4 states out of 6 major swing states. 
